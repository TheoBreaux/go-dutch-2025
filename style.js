...
export default StyleSheet.create({
  // ================================================================================================================================== FAVORITES ICON
  favoritesIcon: { padding: 5, borderRadius: 30, alignItems: 'center' },
  // ================================================================================================================================== RESTAURANTS SCREEN
  resturantsScreen: {
  ...
  restaurantTile: {
    container: {
      ...
      imageContainer: {
        ...
        // overflow: 'hidden',
        marginRight: 10,
        image: { width: SCREEN_WIDTH * 0.25, height: '100%', resizeMode: 'contain' },
      },
      textContainer: {
  ...
  signUpScreen: {
    ...
    imageContainer: {
      icon: {
        ...
        justifyContent: 'center',
        alignItems: 'center',
        height: CIRCLE_SIZE * 0.12,
        width: CIRCLE_SIZE * 0.12,
        borderRadius: (CIRCLE_SIZE * 0.12) / 2,
        position: 'absolute',
        borderWidth: 2,
        top: SCREEN_HEIGHT * 0.27,
        borderColor: COLORS.goDutchBlue,
        left: SCREEN_WIDTH * 0.62,
      },
    },
  ...
  restaurantDetailsScreen: {
    ...
    cuisineMarker: {
      ...
      height: 'auto',
      backgroundColor: 'white',
      text: { fontFamily: 'Poppins-BlackItalic', color: COLORS.goDutchRed, fontSize: scaleFont(18) },
    },
    ...
    restaurantInfoContainer: {
      ...
      justifyContent: 'space-between',
      text: {
        name: { fontFamily: 'Poppins-ExtraBold', fontSize: scaleFont(25), marginTop: SCREEN_HEIGHT * 0.04, marginBottom: -SCREEN_HEIGHT * 0.005 },
  ...
  checkCloseOutDetailsScreen: {
    ...
    finalBillDisplayTileContainer: {
      ...
      text: {
        ...
        primaryDinerText: { color: COLORS.goDutchRed, fontFamily: 'Poppins-ExtraBold', fontSize: SCREEN_WIDTH < 400 ? scaleFont(16) : scaleFont(18) },
        total: { color: COLORS.goDutchBlue, fontFamily: 'Poppins-ExtraBold', fontSize: SCREEN_WIDTH < 400 ? scaleFont(15) : scaleFont(20) },
        eventTitle: { color: COLORS.goDutchBlue, fontFamily: 'Poppins-BlackItalic', fontSize: scaleFont(25) },
        thankYou: {
          fontFamily: 'Poppins-Bold',
          fontSize: SCREEN_WIDTH < 400 ? scaleFont(20) : scaleFont(26),
          color: COLORS.goDutchBlue,
          textAlign: 'center',
          marginBottom: SCREEN_HEIGHT < 815 ? SCREEN_HEIGHT * 0.085 : SCREEN_HEIGHT * 0.015,
        },
      },
  ...
  confirmTotalsScreen: {
    container: {
      ...
      shadowOpacity: 0.2,
      shadowRadius: 4,
      marginTop: Platform.OS === 'android' ? SCREEN_HEIGHT * 0.025 : SCREEN_HEIGHT * 0.015,
      alignItems: 'center',
